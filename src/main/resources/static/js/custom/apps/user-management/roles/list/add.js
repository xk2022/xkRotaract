...
var KTUsersAddRole = function () {
    ...
    const form = element.querySelector('#kt_modal_input');
             ...
             if (validator) {
                 validator.validate().then(function (status) {
                     ...
                     if (status == 'Valid') {
                         ...
                         var checkedMenus = Array();
                         checkedMenus.push(1);
                         $("input:checkbox[name=menu]:checked").each(function(){
                             checkedMenus.push($(this).val());
                         });
                         $('[name="menus"]').val(checkedMenus);
...
// Update
function edit_btn(id, name, description) {
